...
\begin{itemize}
    ...
    \item attivare o disattivare la meccanica di \textbf{Battaglia}.
\end{itemize}
...
\begin{enumerate}
    ...
    \item In caso di collisione tra due pedine sulla stessa casella, si attiva automaticamente la meccanica di Battaglia, se abilitata in fase di configurazione.
\end{enumerate}
...
Il modulo richiede il nome del compilatore, il ruolo (docente, alunno o altro), il tipo di esperienza con il gioco (versione fisica, digitale o entrambe) e la modalità di gioco utilizzata (schermo singolo o multischermo).
...
Un'ultima domanda facoltativa chiede al compilatore se si riconosce nello spettro autistico, utile per leggere i feedback anche in relazione a eventuali bisogni specifici.
...
Seguono le medie delle valutazioni numeriche e tre grafici a barre con la distribuzione dei compilatori per ruolo, esperienza di gioco e identificazione neurodivergente: ciascuna barra è cliccabile e applica un filtro che ricalcola tutte le metriche della pagina sul sottoinsieme selezionato (i filtri sono cumulabili e removibili singolarmente). L'elenco dei commenti liberi chiude la pagina.
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[b]{0.35\textwidth}
        \centering
        \includegraphics[width=0.7\linewidth]{immagini/screenshots/multiplayer-quiz-player}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[b]{0.35\textwidth}
        \centering
        \includegraphics[width=0.7\linewidth]{immagini/screenshots/multiplayer-physical-test-player}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[b]{0.35\textwidth}
        \centering
        \includegraphics[width=0.7\linewidth]{immagini/screenshots/multiplayer-dictation-draw-player}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[b]{0.35\textwidth}
        \centering
        \includegraphics[width=0.7\linewidth]{immagini/screenshots/multiplayer-mime-player}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Mimo} --- il tema da rappresentare compare esclusivamente sul dispositivo del giocatore attivo; gli altri vedono solo il tipo di sfida. Al termine, l'educatore seleziona quale giocatore ha indovinato, e quest'ultimo riceve il beneficio;
        \item \textbf{Parole alle spalle e Disegno dettato} --- il giocatore attivo sceglie il compagno destinatario prima di iniziare; la parola o il disegno compaiono solo sul suo dispositivo. Se la sfida riesce, entrambi avanzano di una casella;
...
Infine, come discusso nella sezione~\ref{sec:multi-dispositivo}, la modalità multi-dispositivo introduce una tensione tra accessibilità e qualità dell'interazione sociale che non è stata misurata empiricamente.
