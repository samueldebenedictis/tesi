...
\section{L'autismo}
"Autistico" è un aggettivo coniato dallo psichiatra svizzero Eugen Bleur per descrivere la chiusura in sé stessi di alcuni suoi pazienti (dal greco \textit{autos}) ed in seguito viene utilizzato da molti autori per descrivere difficoltà osservate in pazienti bambini e adolescenti.
...
Leo Kanner nello stesso anno riporta le osservazioni compiute su undici bambini caratterizzate da "marcate difficoltà nelle relazioni sociali e nella comunicazione", ed in un lavoro successivo propone di chiamare questa sindrome "autismo infantile".
...
Il Centro Formazione Professionale Integrazione Lavorativa (CFPIL), istituito dalla Provincia di Varese, rappresenta un punto di riferimento consolidato da oltre trent'anni per l'utenza disabile intellettiva, fisica e sensoriale. Nel 2002, il centro è stato integrato all'interno dell'"Agenzia Formativa della Provincia di Varese", divenuta successivamente Azienda Speciale nel dicembre 2009.
