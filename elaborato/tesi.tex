...
Negli anni Settanta Lorna Wing mise in discussione l'idea che l'autismo potesse essere ricondotto a criteri diagnostici univoci: fornì le prime prove sistematiche della sua natura composita e introdusse l'espressione \textit{"disturbo dello spettro autistico"}.
...
Lavorare in contesti reali e motivanti, con ruoli definiti e una logica procedurale, permette di sviluppare le competenze sociali in modo più efficace rispetto agli esercizi astratti --- e favorisce la generalizzazione di quanto appreso al di fuori del contesto scolastico o terapeutico.
...
\begin{itemize}
    ...
    \item \textbf{Cosa faresti se\dots} --- Il giocatore risponde a uno scenario ipotetico e gli altri valutano la risposta; allena la prospettiva altrui, una delle abilità più difficili da sviluppare nel DSA.
...
Le caselle speciali non sono scelte in modo arbitrario: nel loro insieme, coprono le aree di difficoltà strutturale che la letteratura individua come caratteristiche del DSA --- lettura delle espressioni facciali e del linguaggio non verbale, decodifica dei gesti, assunzione della prospettiva altrui, comunicazione verbale precisa, gestione delle emozioni, collaborazione e competizione regolamentata \cite{mesibov2005}. La varietà delle sfide garantisce che durante la partita vengano esercitate competenze eterogenee, mantenendo alto il coinvolgimento dei partecipanti.
...
La letteratura si è concentrata quasi esclusivamente su software sviluppati ex novo, lasciando inesplorato il gioco da tavolo in versione digitale. A differenza dei serious games recensiti da Carneiro et al. \cite{carneiro2024}, progettati per uso individuale o mediato dallo schermo, \textit{La Città degli Imprevisti} mantiene l'interazione faccia a faccia attorno a un tavolo condiviso e richiede la mediazione di un educatore. I domini che esercita --- riconoscimento delle emozioni, comunicazione non verbale, prospettiva altrui, collaborazione, gestione della competizione --- coincidono con le aree di intervento prioritarie nel DSA identificate dalla letteratura.
...
È stato scelto come framework principale per la sua capacità di produrre output statici distribuibili su GitHub Pages senza necessità di un server, mantenendo al contempo un'esperienza di sviluppo moderna.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{immagini/screenshots/game-board-chromium-linux}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{immagini/screenshots/home-filled-chromium-linux}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{immagini/screenshots/dice-roll-chromium-linux}
...
Le figure~\ref{fig:modali-1} e~\ref{fig:modali-2} mostrano le finestre modali corrispondenti a ciascuna sfida, così come appaiono durante la partita.

\begin{figure}[htbp]
    \centering
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{immagini/screenshots/mime-modal-topic-chromium-linux}
        \par\smallskip\small Mimo.
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{immagini/screenshots/quiz-modal-answer-chromium-linux}
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{immagini/screenshots/backwrite-modal-word-chromium-linux}
        \par\smallskip\small Parole alle spalle.
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{immagini/screenshots/dictation-draw-modal-image-chromium-linux}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{immagini/screenshots/music-emotion-modal-chromium-linux}
        \par\smallskip\small Emozioni in musica.
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{immagini/screenshots/face-emotion-modal-answer-chromium-linux}
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{immagini/screenshots/what-would-you-do-modal-chromium-linux}
        \par\smallskip\small Cosa faresti se\ldots
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{immagini/screenshots/physical-test-modal-chromium-linux}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{immagini/screenshots/advanced-mode-chromium-linux}
...
Il modulo richiede il nome del compilatore, il ruolo (docente, alunno o altro) e il tipo di esperienza maturata con il gioco (versione fisica, digitale o entrambe).
Una sezione di valutazione numerica (scala 1--5) raccoglie giudizi su accessibilità, fedeltà della versione digitale rispetto a quella fisica, chiarezza visiva e comfort sonoro.
Tre campi di testo libero permettono infine di descrivere gli aspetti positivi, le difficoltà riscontrate e i suggerimenti per miglioramenti futuri.
Le risposte sono inviate tramite il servizio Formspree e archiviate per analisi successive.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{immagini/screenshots/end-game-chromium-linux}
...
\begin{itemize}
    ...
    \item \textbf{accessibilità} --- valutazione in scala 1--5;
    \item \textbf{fedeltà della versione digitale rispetto a quella fisica} --- valutazione in scala 1--5;
    \item \textbf{chiarezza visiva} --- valutazione in scala 1--5;
    \item \textbf{comfort sonoro} --- valutazione in scala 1--5;
