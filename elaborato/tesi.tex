...
\begin{itemize}
    ...
    \item scegliere quali tipologie di caselle speciali includere tra: Mimo, Quiz, Parole alle spalle, Disegno dettato, Emozioni in musica, Indovina l'emozione, Film, Cosa faresti se\ldots, Test fisico, Caselle movimento;
...
Il mazzo della sfida ``Film'' (\texttt{FilmDeck}) contiene cinque scene, una per ciascuna emozione di base della sfida precedente esclusa la neutralità (felicità, rabbia, tristezza, disgusto, paura). Ogni carta associa l'emozione corretta a un file video servito dall'applicazione; a differenza delle immagini, il video viene riprodotto con l'audio e avviato dall'utente tramite i comandi del player.
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Emozione facciale, Film, Emozione musicale, Test fisico, Cosa faresti se\ldots} --- la sfida è visibile a tutti; l'educatore registra l'esito al termine;
