...
Le risposte sono inviate all'endpoint interno \texttt{/api/feedback} e archiviate su Redis per analisi successive; un endpoint protetto da chiave segreta consente di esportare le risposte raccolte.
