...
| `film` | Guess the emotion of a film scene (video in `public/videos/`) |
...
10 decks, one per action type. Each deck is a shuffled array of cards dealt in rotation.
